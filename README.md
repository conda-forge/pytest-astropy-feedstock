...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3260&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-astropy-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-astropy` can be installed with `conda`:
...
```
mamba install pytest-astropy
```

It is possible to list all of the versions of `pytest-astropy` available on your platform with `conda`:
...
```
mamba search pytest-astropy --channel conda-forge
```
...
mamba repoquery search pytest-astropy --channel conda-forge

# List packages depending on `pytest-astropy`:
mamba repoquery whoneeds pytest-astropy --channel conda-forge

# List dependencies of `pytest-astropy`:
mamba repoquery depends pytest-astropy --channel conda-forge
```
